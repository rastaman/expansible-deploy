...
class DockerManager(object):
    ...
    def get_start_params(self):
        ...
        for optional_param in ('dns', 'volumes_from', 'restart_policy',
                ...
                'cap_add', 'cap_drop', 'read_only', 'log_opt','volume_driver'):
        ...
        if optionals['volume_driver'] is not None:
            self.ensure_capability('volume_driver')
            params['volume_driver'] = optionals['volume_driver']
    ...
    def get_differing_containers(self):
        ...
        for container in current:
            ...
            expected_volume_driver = set(self.module.params.get('volume_driver') or [])
            actual_volume_driver = set(container['HostConfig']['VolumeDriver'] or [])
            if actual_volume_driver != expected_volume_driver:
                self.reload_reasons.append('volume_driver ({0} => {1})'.format(actual_volume_driver, expected_volume_driver))
                differing.append(container)
    ...
    def create_containers(self, count=1):
        ...
        params = {'image':        self.module.params.get('image'),
                  ...
                  'volume_driver':self.module.params.get('volume_driver'),
...
def main():
    module = AnsibleModule(
        argument_spec = dict(
            ...
            volume_driver   = dict(default=None),
